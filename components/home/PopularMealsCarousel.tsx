...
// See PromoCarousel.tsx — FlatList's scroll direction follows
// I18nManager.isRTL natively, so flip-and-unflip to keep the swipe feel
    ...
    <View>
      <FlatList
        ...
        renderItem={({ item, index: i }) => (
          <View
            style={[{ width: CARD_W }, RTL && { transform: [{ scaleX: -1 }] }]}
          >
