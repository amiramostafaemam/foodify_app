...
const en = {
  ...
  "cart.addressRequiredTitle": "Delivery address required",
  "cart.addressRequiredMsg": "Please choose a delivery address before placing your order.",
  ...
  "auth.resetCodeSub": "We've sent a 6-digit code to {email}.",
  "auth.resetCodePlaceholder": "6-digit code",
  "auth.resetVerifyCode": "Verify code",
  "auth.resetResendCode": "Resend code",
  "auth.resetNewPasswordTitle": "Set a new password",
  "auth.resetNewPasswordSub": "Choose a new password for your account.",
  "auth.resetNewPasswordPlaceholder": "New password",
  "auth.resetSetPassword": "Update password",
  "auth.resetSuccessTitle": "Password updated",
  "auth.resetSuccessMsg": "Your password has been changed. You're signed in.",
  "auth.errInvalidCode": "That code is invalid or has expired.",
  "auth.errCodeLen": "Enter the 6-digit code",
...
const ar: Record<Key, string> = {
  ...
  "cart.addressRequiredTitle": "عنوان التوصيل مطلوب",
  "cart.addressRequiredMsg": "يرجى اختيار عنوان توصيل قبل إتمام طلبك.",
  ...
  "auth.resetSub":
    "أدخل بريدك الإلكتروني وسنرسل إليك كود مكوّن من ٦ أرقام لإعادة تعيين كلمة المرور.",
  "auth.resetSend": "إرسال الكود",
  "auth.resetSending": "جارٍ الإرسال…",
  "auth.resetDone": "تم",
  "auth.resetCodeTitle": "أدخل الكود",
  "auth.resetCodeSub": "لقد أرسلنا كوداً مكوّناً من ٦ أرقام إلى {email}.",
  "auth.resetCodePlaceholder": "الكود المكوّن من ٦ أرقام",
  "auth.resetVerifyCode": "تأكيد الكود",
  "auth.resetResendCode": "إعادة إرسال الكود",
  "auth.resetNewPasswordTitle": "تعيين كلمة مرور جديدة",
  "auth.resetNewPasswordSub": "اختر كلمة مرور جديدة لحسابك.",
  "auth.resetNewPasswordPlaceholder": "كلمة المرور الجديدة",
  "auth.resetSetPassword": "تحديث كلمة المرور",
  "auth.resetSuccessTitle": "تم تحديث كلمة المرور",
  "auth.resetSuccessMsg": "تم تغيير كلمة المرور بنجاح، وتم تسجيل دخولك.",
  "auth.errInvalidCode": "هذا الكود غير صحيح أو انتهت صلاحيته.",
  "auth.errCodeLen": "أدخل الكود المكوّن من ٦ أرقام",
